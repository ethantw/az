    ...
    var IO = React.createClass({
      ...
      render: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            'div',
            { id: 'out', 'data-picking': this.state.picking },
