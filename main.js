  ...
  _utilJs2['default'].XHR('./data/reverse.min.json', function (reverse) {
    ...
    var Nav = React.createClass({
      ...
      render: function render() {
        return React.createElement(
          ...
          React.createElement(
            'button',
            { className: 'option', onClick: this.toggleOption },
            '設定'
          ),
          React.createElement(
            'a',
    ...
    var IO = React.createClass({
      ...
      handleInput: function handleInput(e) {
        ...
        var output = _utilJs2['default'].wrap.complex(annotated.html);
        var picking = false;
        this.setState({ input: input, output: output, az: az, picking: picking });
      },

      togglePicking: function togglePicking() {
      ...
      pickZi: function pickZi(e) {
        ...
        var picking = true;
        this.setState({ current: current, zi: zi, pickrXY: pickrXY, picking: picking });
      },
      ...
      render: function render() {
        ...
        return React.createElement(
          'main',
          { id: 'io', className: 'layout', 'data-picking': this.state.picking },
    ...
    var Page = React.createClass({
      ...
      render: function render() {
        return React.createElement(
          ...
          React.createElement(_optionJsx2['default'], { parent: this })
        );
      }
    });
...
},{"./option.jsx":2,"./pickr.js":3,"./util.js":4}],2:[function(require,module,exports){
'use strict';
...
var Close = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'button',
      { className: 'close', onClick: this.closeOption },
      '關閉'
    );
  }
});
