...
document.addEventListener('keydown', function (e) {
  ...
  switch (KEY[e.which]) {
    ...
    default:
      ...
      pickYin($pickr.querySelector('li:nth-child(' + nth + ')') || $pickr.querySelector('li:last-child'), idx);
  }
});
...
},{"./reg":3,"./util":4,"./view.jsx":5}],2:[function(require,module,exports){
'use strict';
...
},{"./reg":3}],5:[function(require,module,exports){
'use strict';
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            current.map(function (sound, i) {
              var currentYin = _this2.state.currentYin || 0;
              var display = Util.LS.get('display');
...
},{"./pref.jsx":2,"./reg":3}],6:[function(require,module,exports){
(function (global){
"use strict";
